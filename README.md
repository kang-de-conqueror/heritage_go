...
the Héritage GO's logo;
Name of the detected area where the user is currently located in, decomposed in two lines, where the top line refers to the primary area, basically the city (e.g., Sa Đéc), and the bottom line refers to a secondary larger area (e.g., Đồng Tháp, Việt Nam).
a compass icon that allows the user to request the Web application to geolocate him more accurately;
a button that allows the user to log-in.
...
Avatar of the user who posted this photo;
Caption of the photo;
Icon that allows the user to translate the caption in his preferred languages;
Location where the photograph has been taken;
Precise or approximate date when this photograph has been taken;
Number of users who liked this photo;
Number of comments posted by users to this photo;
Number of rephotographies of this photo;
Icon that allows the user to bookmark this photo;
Edit field that allows the user to enter and post a comment to this photo.
...
picture_url (optional): Uniform Resource Locator (URL) that specifies the location of the organization's picture. The client application can use this URL and append the query parametersize to specify a given pixel resolution of the picture, such as thumbnail, small, medium, large.
